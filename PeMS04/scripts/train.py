...
sys.path.append('../../')
from PeMS04.dataloader.milano_crop import load_data
from PeMS04.models.model import T_STGCN
from PeMS04.utils.lr_scheduler import LR_Scheduler
from PeMS04.utils.parser import getparse
from PeMS04.utils.metrics import getmetrics
#from PeMS04.utils.show import plot
import time
...
if __name__ == '__main__':
    ...
    x_train, y_train, x_test, y_test, mmn = load_data(path, opt.close_size, opt.period_size, opt.trend_size,opt.test_size)
